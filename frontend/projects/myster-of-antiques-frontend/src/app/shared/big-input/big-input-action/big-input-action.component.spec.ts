...
@Component({
  selector: 'frontend-host-for-test',
  template: ''
})
class HostComponent {
  actionHandler = () => {};
...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<frontend-big-input-action></frontend-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<frontend-big-input-action [disabled]="true"></frontend-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<frontend-big-input-action fontSet="fas" fontIcon="fa-trash"></frontend-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<frontend-big-input-action label="delete"></frontend-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<frontend-big-input-action (action)="actionHandler()"></frontend-big-input-action>`;
    fixture = createHostComponent(template);
