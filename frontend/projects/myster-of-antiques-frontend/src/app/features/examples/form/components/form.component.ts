    ...
    if (this.form.valid) {
      ...
      this.notificationService.info(
        (this.form.value.requestGift
          ? this.translate.instant('frontend.examples.form.text4')
          : this.translate.instant('frontend.examples.form.text5')) +
          ' : ' +
          this.translate.instant('frontend.examples.form.text6')
      );
    }
  }
